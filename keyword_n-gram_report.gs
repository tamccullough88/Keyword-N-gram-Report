...
var spreadsheetUrl = "https://docs.google.com/spreadsheets/d/1ML8rj25AK-8hqCAjFZJ-B7yQxKbHSZhzevlCAurn82E/edit#gid=0";
...
//Creates negative keyword array with AdGroupId Reference
...
Logger.log("Finished writing to spreadsheet.");// end main function
}
...
Logger.log("Wrote %s %s with %s entries",nGramName, levelName, outputArray.length);
break;
